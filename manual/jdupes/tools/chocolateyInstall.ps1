...
$packageArgs = @{
  ...
  url           = "https://github.com/jbruchon/jdupes/releases/download/v${currentVersion}/jdupes-${currentVersion}-win32.zip"
  checksum      = '1fb1a1d6070f2bdd1bafea82fae56938ac907fef9c3214f094ff905df714ed65'
  checksumType  = 'sha256'
  url64bit      = "https://github.com/jbruchon/jdupes/releases/download/v${currentVersion}/jdupes-${currentVersion}-win64.zip"
